  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto px-4 py-16 prose prose-gray">
        ...
        <p className="text-gray-600 mt-4">Kingdom Folk membership is ${MEMBERSHIP_PRICE}/month after a {TRIAL_DAYS}-day free trial, billed recurring through Stripe. You choose one lane: single, couple, or family. Promo codes may be applied at checkout.</p>
